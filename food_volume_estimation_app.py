...
if __name__ == '__main__':
    ...
    parser.add_argument('--depth_model_architecture', type=str,
                        ...
                        metavar='./models/fine_tune_food_videos/monovideo_fine_tune_food_videos.json',
                        required=True)
    parser.add_argument('--depth_model_weights', type=str,
                        help='Path to depth model weights (.h5).',
                        metavar='./models/fine_tune_food_videos/monovideo_fine_tune_food_videos.h5',
                        required=True)
    parser.add_argument('--segmentation_model_weights', type=str,
                        help='Path to segmentation model weights (.h5).',
                        metavar='./models/segmentation/mask_rcnn_food_segmentation.h5',
                        required=True)
